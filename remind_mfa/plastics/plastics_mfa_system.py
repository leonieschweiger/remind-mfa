...
class PlasticsMFASystemFuture(fd.MFASystem):
    ...
    def compute_flows(self, historic_trade: TradeSet):
        ...
        flw["collected => reclmech"][...] = (flw["eol => collected"] + flw["waste_market => collected"] - flw["collected => waste_market"]) * prm["hist_mechanical_recycling_rate"]
        ...
        flw["collected => incineration"][...] = (flw["eol => collected"] + flw["waste_market => collected"] - flw["collected => waste_market"]) * prm["hist_incineration_rate"]
